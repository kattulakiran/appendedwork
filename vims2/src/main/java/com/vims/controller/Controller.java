...
public class Controller {
	...
	public ResponseEntity<?> Payment(@PathVariable("policy_id") String policy_id) {
		...
		if(d1.after(max)) {
			return  new ResponseEntity<String>("registeredpay", HttpStatus.OK);
		}
		return  new ResponseEntity<String>("directpay", HttpStatus.OK);
	}
	...
	public ResponseEntity<?> saveRegisteredPay(@RequestBody RegisteredPay pay,@PathVariable("policy_id") String policy_id) {
		...
		return new ResponseEntity<String>("payment processed successfully with payment id: "+pay.getPayment_id()+"and next payment date is: "+pay.getDue_date(), HttpStatus.OK);
	}
	...
	public ResponseEntity<?> saveAccidentClaim(@RequestBody AccidentClaim accidentclaim,@PathVariable("custId") String custId,@PathVariable("policy_id") String policy_id) {
        ...
        double claimamount=((Double.parseDouble(accidentclaim.getTotal_amount())*Double.parseDouble(accidentclaim.getWeightage())/100));
		...
		accidentclaim.setClaim_amount(Double.toString(amount));
